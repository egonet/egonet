 ...
 * 
 * @ejb.bean name = "QuestionLinkEJB" type = "CMP" cmp-version = "2.x"
 *           display-name = "QuestionLinkEJB" description = "QuestionLink EJB"
 *           view-type = "both" jndi-name = "QuestionLinkEJBHome"
 *           local-jndi-name = "QuestionLinkEJBLocalHome"
 * 
 * @ejb.util generate = "physical"
 * 
 * @ejb.persistence table-name = "QuestionLinkEJB"
 * 
 * @ejb.transaction type = "Required"
 * 
 * @ejb.value-object name = "QuestionLinkData" match = "*"
 * 
 * @ejb.pk class = "com.endlessloopsoftware.egonet.interfaces.QuestionLinkEJBPK"
 * 
 * @ejb.finder signature =
 *             "com.endlessloopsoftware.egonet.interfaces.QuestionLinkEJBLocal
 *             findByPrimaryKey(com.endlessloopsoftware.egonet.interfaces.QuestionLinkEJBPK
 *             pk)" description = "Find all instances of this type" query =
 *             "SELECT OBJECT(a) FROM QuestionLinkEJB AS a WHERE a.id=?"
 * 
 */
public abstract class QuestionLinkEJB implements EntityBean {
	 ...
	 * method on an entity bean instance when a client invokes a matching create<METHOD>(...)
	 * method on the entity bean's home interface.<br>
	 * 
	 ...
	 * the get and set accessor methods, such that when the ejbCreate<METHOD>(...)
	 * method returns, the persistent representation of the instance can be
	 * created. <br>
	 * 
	 ...
	 * determined by the transaction attribute of the matching create<METHOD>(...)
	 * method. The database insert operations are performed by the container
	 * within the same transaction context after the Bean Provider's ejbCreate<METHOD>(...)
	 * method completes.
	 * 
	 ...
	 * @ejb.create-method
	 */
	public QuestionLinkEJBPK ejbCreate(QuestionLinkDataValue data, QuestionEJBLocal question)
			throws CreateException {
	 ...
	 * method. The instance may, for example, obtain the component interface of
	 * the associated entity object and pass it to another enterprise bean as a
	 * method argument.<br>
	 * 
	 ...
	 *             requested by the container because of an system-level error.
	 */
	public void ejbPostCreate(QuestionLinkDataValue data, QuestionEJBLocal question)
			throws CreateException {
	...
	/**
	 * @ejb.persistence column-name = "QUESTION_ID"
	 */
	...
	/**
	 * @ejb.persistence column-name = "ANSWER_VALUE"
	 * 
	 */
	...
	/**
	 * @ejb.persistence column-name = "ANSWER_STRING"
	 * 
	 */
	...
	/**
	 * @ejb.persistence column-name = "ACTIVE"
	 */
...
/**
 * $Log: QuestionLinkEJB.java,v $ Revision 1.9 2004/04/08 15:03:06 admin
 ...
 * 
 * Revision 1.8 2004/03/28 17:30:06 admin Display applet in complete screen Mark
 ...
 * 
 * Revision 1.5 2004/02/07 04:33:25 admin First egoquestions page
 * 
 * Revision 1.4 2004/01/30 23:31:08 admin Using struts-layout
 * 
