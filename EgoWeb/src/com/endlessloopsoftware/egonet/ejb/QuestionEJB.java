 ...
 *
 * $Id: QuestionEJB.java,v 1.12 2004/05/14 15:06:07 admin Exp $
 */
 ...
 * 
 *	@ejb.bean name 			= "QuestionEJB"
 *		type 					= "CMP"
 *    cmp-version 			= "2.x"
 *    display-name 		= "QuestionEJB"
 *    description 			= "Question EJB"
 *    view-type 			= "both"
 *		reentrant				= "true"
 *    jndi-name 			= "QuestionEJBHome"
 *    local-jndi-name 	= "QuestionEJBLocalHome"
 *
 *	@ejb.util
 *		generate				= "physical"
 * 
 *	@ejb.persistence
 *		table-name 			= "QuestionEJB"
 * 
 *	@ejb.transaction
 *		type					= "Required"
 * 
 *	@ejb.pk
 *		class 					= "com.endlessloopsoftware.egonet.interfaces.QuestionEJBPK"
 * 
 *	@ejb.finder 
 *		signature 			= "com.endlessloopsoftware.egonet.interfaces.QuestionEJBLocal findByPrimaryKey(com.endlessloopsoftware.egonet.interfaces.QuestionEJBPK pk)"
 *		description 			= "Find all instances of this type"
 *		query 					= "SELECT OBJECT(a) FROM QuestionEJB AS a WHERE a.id=?"
 * 		
 */
public abstract class QuestionEJB implements EntityBean
{
    ...
    *    view-type     = "local"
	 ...
	 * 		view-type = "local"
	 */
	public void addAnswer(AnswerDataValue added)
	 ...
	 * 		view-type = "local"
	 */
	public void removeAnswer(AnswerDataValue removed)
	 ...
	 * 		view-type = "local"
	 */
	public void addSelection(SelectionDataValue added)
	 ...
	 * 		view-type = "local"
	 */
	public void removeSelection(SelectionDataValue removed)
	throws javax.ejb.RemoveException
	{
		try
		{
	 ...
	 * 		view-type = "local"
	 */
	public void updateSelection(SelectionDataValue updated)
	throws javax.ejb.FinderException
	{
		try
		{
      ...
      QuestionEJBPK pk = new QuestionEJBPK(getId(), getStudyId());
		...
		try
		{
			...
			if (getQuestionLink() != null)
				QuestionDataValue.setQuestionLinkDataValue(getQuestionLink().getQuestionLinkDataValue());
			...
			{
				QuestionDataValue.addSelectionDataValue(((SelectionEJBLocal) iSelectionDataValue.next())
	...
	public void setQuestionDataValue( QuestionDataValue valueHolder )
	{
		try
		{
...

			{
				...
				java.util.Iterator iAnswerDataValue = valueHolder.getAddedAnswerDataValues().iterator();
				while (iAnswerDataValue.hasNext())
				{
			...
			}
			{
				...
				{
					QuestionLinkEJBPK pk = new QuestionLinkEJBPK(valueHolder.getQuestionLinkDataValue().getId());
			...
			// Anonymous block to allow variable declations without conflicts
			{
				...
				java.util.Iterator iSelectionDataValue = valueHolder.getUpdatedSelectionDataValues().iterator();
				while (iSelectionDataValue.hasNext())
				{
	 ...
	 *  	role-name 		= "Question-To-Selections"
	 * 
	 * 
	 *	@ejb.value-object
	 *		compose			=	"com.endlessloopsoftware.egonet.util.SelectionDataValue"
	 *		compose-name		=	"SelectionDataValue"
	 *   	members			=	"com.endlessloopsoftware.egonet.interfaces.SelectionEJBLocal"
	 ...
	 *  	role-name 		= "Question-To-Answers"
	 * 
	 * 
	 *	@ejb.value-object
     *		aggregate			=	"com.endlessloopsoftware.egonet.util.AnswerDataValue"
     *		aggregate-name	=	"AnswerDataValue"
	 ...
	 *  		role-name 			= "Question-To-QuestionLink"
	 * 
	 *	@jboss.relation
	 * 		fk-column 				= "QUESTION_LINK"
	 * 		related-pk-field		= "id"
	 * 
	 *	@ejb.value-object
     *		aggregate					=	"com.endlessloopsoftware.egonet.data.QuestionLinkDataValue"
     *		aggregate-name			=	"QuestionLinkDataValue"
     *   	members					=	"com.endlessloopsoftware.egonet.interfaces.QuestionLinkEJBLocal"
     *   	members-name				=	"QuestionLink"
     *   	relation					=	"external"
	 */
...
/**
 * $Log: QuestionEJB.java,v $
 * Revision 1.12  2004/05/14 15:06:07  admin
 ...
 *
 * Revision 1.8  2004/03/12 18:05:28  admin
