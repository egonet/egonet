	...
	implements Observer
{
   ...
   private final JMenuItem    jMenuFileSelectStudy = new JMenuItem("Select Active Study");
   ...
   private final EgoQPanel[]  questionPanel        = { null, (EgoQPanel) new QuestionPanel(Question.EGO_QUESTION),
         (EgoQPanel) new PromptPanel(Question.ALTER_PROMPT), (EgoQPanel) new QuestionPanel(Question.ALTER_QUESTION),
         (EgoQPanel) new QuestionPanel(Question.ALTER_PAIR_QUESTION),};
			...
			throws Exception
	{
      ...
      this.addWindowListener(new CloseListener());
		...
		jMenuFileExit.setAccelerator(javax.swing.KeyStroke.getKeyStroke(KeyEvent.VK_Q, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
		...
		jMenuFileOpen.setAccelerator(javax.swing.KeyStroke.getKeyStroke(KeyEvent.VK_O, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
		...
		jMenuEditCut.setAccelerator(javax.swing.KeyStroke.getKeyStroke(KeyEvent.VK_X, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
		jMenuEditPaste.setAccelerator(javax.swing.KeyStroke.getKeyStroke(KeyEvent.VK_V, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
	...
	public void updateMenus()
	{
		...
		else
		{
			...
			jMenuFileSave.setEnabled(EgoNet.study.isCompatible() && EgoNet.study.isModified());
   ...
   {
      AboutBox dlg = new AboutBox((JFrame) this, "Egocentric Network Survey Suite", 
                                    "Survey Creation Program", Shared.version);
      dlg.showAboutBox();
   }
	...
	public boolean closeStudyFile()
	{
		...
		{
			int confirm = JOptionPane.showConfirmDialog(this, "There are unsaved changes to the study. Would you like to save the study now?",
				"Save Study Changes", JOptionPane.YES_NO_CANCEL_OPTION);
	...
	public void fillCurrentPanel()
	{
		...
		else if ((curTab >= Question.MIN_QUESTION_TYPE) && (curTab <= Question.MAX_QUESTION_TYPE))
		{
	...
	private void jTabbedPane_stateChanged(ChangeEvent e)
	{
		...
		if ((curTab >= Question.MIN_QUESTION_TYPE) && (curTab <= Question.MAX_QUESTION_TYPE))
		{
			questionPanel[curTab].fillPanel();
		}
 ...
 * Fixing headers
 *
 * Revision 1.11  2004/04/08 15:06:06  admin
 ...
 *
 * Revision 1.9  2004/03/23 14:58:48  admin
 * Update UI
 ...
 *
 * Revision 1.7  2004/03/10 14:32:39  admin
 * Adding client library
 * cleaning up code
 *
 * Revision 1.6  2004/02/10 20:10:42  admin
 * Version 2.0 beta 3
 *
 * Revision 1.5  2004/01/23 13:36:07  admin
 * Updating Libraries
 ...
 *
 * Revision 1.13  2002/08/30 16:50:27  admin
 * Using Selections
 *
 * Revision 1.12  2002/08/11 22:26:05  admin
 * Final Statistics window, new file handling
 *
 * Revision 1.11  2002/08/08 17:07:24  admin
 * Preparing to change file system
 *
 * Revision 1.10  2002/07/24 14:17:08  admin
 * xml files, links
 *
 * Revision 1.9  2002/07/18 14:43:05  admin
 * New Alter Prompt Panel, packages
 *
 * Revision 1.8  2002/06/26 15:43:42  admin
 ...
 * Much UI work done
 *
 * Revision 1.3  2002/06/16 17:53:10  admin
 * Working with files
 *
