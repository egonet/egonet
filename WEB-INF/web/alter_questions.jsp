 ...
 *
 *  $Id: alter_questions.jsp,v 1.3 2004/03/18 15:23:39 admin Exp $
 --%>
...
<layout:html locale="true" styleClass="FORM" key='global.title'>
	...
	<layout:form action="/alterquestionsSubmit" onsubmit="return validateAlterQuestionsForm(this)" styleClass="FORM" key="alterquestions.title">
